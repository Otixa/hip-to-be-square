...
public class PointBuff : BuffPickup {
	...
	{
		theScoreManager.pointsPerSecond *= pointsModifier;			//tell score manager to multiply the points per second by buffAmount
		theScoreManager.setBuff (this, buffDuration);
	}

	protected override void OnExpire ()
	{
		theScoreManager.pointsPerSecond /= pointsModifier;			//tell score manager to divide the points per second by theBuffAmount
